  ...
  en: {
    ...
    githubConnect: {
      ...
      tokenHelpGithub: {
        ...
        p2: ". In 'Repository permissions', set ",
        b: 'Contents',
        p3: " to 'Read and write'.",
      },
      tokenHelpGitea: {
    ...
    postList: {
      ...
      error: {
        ...
        invalidSlug: 'Invalid title format. Please use letters, numbers, and spaces only.',
      },
  ...
  vi: {
    ...
    githubConnect: {
      ...
      tokenHelpGithub: {
        p1: 'Tạo một ',
        link: 'Fine-Grained Token',
        p2: ". Trong 'Repository permissions', đặt quyền ",
        b: 'Contents',
        p3: " là 'Read and write'.",
      },
      tokenHelpGitea: {
    ...
    postList: {
      ...
      error: {
        ...
        invalidSlug: 'Tiêu đề không hợp lệ. Vui lòng chỉ sử dụng chữ cái, số và khoảng trắng.',
      },
